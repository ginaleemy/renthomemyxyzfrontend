    ...
    <section id="intro">
      <div class="jumbotron">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h1>Your Free Rental Listing Website</h1>
              <p class="lead">100% Lifetime Commission-Free. Self-Service Matching.</p>
              <a class="btn btn-primary btn-lg" href="/properties/pages/1" role="button">Search</a>
            </div>
          </div>
        </div>
      </div>
...
<script setup>
useHead({
  titleTemplate: "Home - RentHomeMy.Xyz Renting"
})
